...
SECRET_KEY = 'django-insecure-$6pvpdf568glfr@c#r^x3&@fbfx&#i@p4y=d11r_+cqpm@j!b2'
...
SIMPLE_JWT = {
    ...
    # Ensure user gets an error when token expires
...
MIDDLEWARE = [
    ...
    'libraryManagement.middleware.CustomAuthMiddleware'
]
